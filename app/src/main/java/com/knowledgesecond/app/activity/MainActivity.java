...
import com.knowledgesecond.app.db.CacheDbHelper;
import com.knowledgesecond.app.fragment.MainFragment;
import com.knowledgesecond.app.fragment.MenuFragment;
import com.knowledgesecond.app.fragment.NewsFragment;
...
public class MainActivity extends AppCompatActivity{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.getItem(0).setTitle(sp.getBoolean("isLight", true) ? "夜间模式″紡" : "日间模式");
        return true;
    }
